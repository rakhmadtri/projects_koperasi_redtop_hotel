...
<section class="content">
  ...
  <div class="span12">
    ...
    <!-- form start -->
    <form class="form-horizontal" id="form" action="<?php echo base_url() ?>master_Supplier/insertSupplier" method="post">
      <div class="box-body">
        <div class="form-group">
          <label for="inputEmail3" class="col-sm-2 control-label">Kode Supplier</label>
          <div class="col-sm-5">
            <input type="text" name="kode_supplier" class="form-control" placeholder="[AUTO GENERATED]" id="kode"  readonly>
          </div>
        </div>
        <div class="form-group">
          <label for="inputEmail3" class="col-sm-2 control-label">Nama Supplier</label>
          <div class="col-sm-5">
            <input name="nama_supplier" type="text" class="form-control" id="nama" placeholder="Nama Supplier">
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-5">
            <input name="number" type="text" class="form-control" id="no_telfon" placeholder="No Telpon">
          </div>
        </div>
        <div class="form-group">
                  ...
                  <table id="example1" class="table table-bordered table-striped datatable">
                    ...
                    <tbody>
                     <?php if (isset($all_supplier)): ?>
                      <?php foreach ($all_supplier as $value) { ?>
                      <tr>                   
                        ...
                        <td width="16%">
                           <a href="#" class="btn btn-default fa fa-edit btn-default btn_edit" data-kode="<?php echo $value['kode_supplier'] ?>" data-nama="<?php echo $value['nama_supplier'] ?>" 
                                data-alamat="<?php echo $value['alamat']?>" data-notelfon="<?php echo $value['no_telfon'] ?>" data-email="<?php echo $value['email'] ?>" >
                            <i class="icon-pencil icon-white"></i> Edit
                          </a>
                          <a href="<?php echo base_url()."master_Supplier/deleteSupplier/".$value['kode_supplier'] ?>" class="btn btn-default fa fa-trash btn-default" >
...
<script type="text/javascript" src="<?php echo base_url() ?>asset/my_js/scripts_master_Supplier.js"></script>