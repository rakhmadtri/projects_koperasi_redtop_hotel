...
<section class="content">
  ...
  <div class="box box-info">
    <div class="box-header with-border">
      <h3 class="box-title">Form Master Departemen</h3>
  ...
  <div class="span12">
    ...
    <!-- form start -->
    <form class="form-horizontal" id="form" action="<?php echo base_url() ?>master_departemen/insertDepartemen" method="post">
      <div class="box-body">
        <div class="form-group">
          <label for="inputEmail3" class="col-sm-2 control-label">Kode Departemen</label>
          <div class="col-sm-5">
            <input type="text" name="kode_departemen" class="form-control" placeholder="[AUTO GENERATED]" id="kode"  readonly>
          </div>
        </div>
        <div class="form-group">
          <label for="inputEmail3" class="col-sm-2 control-label">Nama Departemen</label>
          <div class="col-sm-5">
            <input name="nama_departemen" type="text" class="form-control" id="nama" placeholder="Nama">
          </div>
        </div>
        <div class="form-group">
      ...
      <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped datatable">
                    ...
                    <tbody>
                     <?php if (isset($all_departemen)): ?>
                      <?php foreach ($all_departemen as $value) { ?>
                      <tr>                   
                        <td><?php echo $value['kode_departemen'] ?></td>
                        <td><?php echo $value['nama_departemen'] ?></td>
                        <td><?php echo $value['keterangan'] ?></td>
                        <td><?php echo $value['created_time'] ?></td>
                        <td width="16%">
                           <a href="#" class="btn btn-default fa fa-edit btn-default btn_edit" data-kode="<?php echo $value['kode_departemen'] ?>" data-nama="<?php echo $value['nama_departemen'] ?>" 
                                data-keterangan="<?php echo $value['keterangan']?>" >
                            <i class="icon-pencil icon-white"></i> Edit
                          </a>
                          <a href="<?php echo base_url()."master_departemen/deleteDepartemen/".$value['kode_departemen'] ?>" class="btn btn-default fa fa-trash btn-default" >
