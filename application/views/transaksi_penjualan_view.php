...
<section class="content">
  ...
  <div class="box box-info">
    ...
    <!-- form start -->
    <div class="row">
        <form class="form-horizontal" method="post" action="<?php echo base_url() ?>transaksi_penjualan/insertTransaction" id="form" target="iframenota">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                      <label class="col-md-6" for="pelanggan">Pelanggan</label>
                        <div class="col-md-6">
                            <select name="anggota" class="form-control select2" style="width: 100%;" id="combocustomer" required=true>
                                <option value="">- PILIH -</option>
                                <option value="newCustomer">- New Customer -</option>
                                <?php foreach ($data_anggota as $value): ?>
                                    <?php if (!empty($detail_penjualan[0]['kode_customer'])): ?>
                                        <option <?php echo $value['no_anggota']==$detail_penjualan[0]['kode_customer']?'selected':'' ?> value="<?php echo $value['no_anggota'] ?>" ><?php echo $value['nama']." - ".$value['nama_departemen']?></option>
                                    <?php else: ?>                                    
...
<script type="text/javascript" src="<?php echo base_url()."asset/my_js/trx.js" ?>"></script>
