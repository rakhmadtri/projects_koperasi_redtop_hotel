    ...
    <form class="form-horizontal" id="form" action="<?php echo base_url() ?>master_jabatan/insertJabatan" method="post">
      <div class="box-body">
        <div class="form-group">
          <label for="inputEmail3" class="col-sm-2 control-label">Kode Jenis Simpanan</label>
          <div class="col-sm-5">
            <input type="text" name="kode_jenis_simpanan" class="form-control" placeholder="[AUTO GENERATED]" id="kode"  readonly>
          </div>
        </div>
        <div class="form-group">
          <label for="inputEmail3" class="col-sm-2 control-label">Nama Jenis Simpanan</label>
          <div class="col-sm-5">
            <input name="nama_simpanan" type="text" class="form-control" id="nama" placeholder="Nama">
          </div>
        </div>
        <div class="form-group">
      ...
      <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped datatable">
                    ...
                    <tbody>
                     <?php if (isset($list_jenis_simpanan)): ?>
                      <?php foreach ($list_jenis_simpanan as $value) { ?>
                      <tr>                   
                        ...
                        <td width="16%">
                           <a href="#" class="btn btn-default fa fa-edit btn-default btn_edit" data-kode="<?php echo $value['kode_jenis_simpanan'] ?>" data-nama="<?php echo $value['nama_simpanan'] ?>" 
                                data-keterangan="<?php echo $value['keterangan']?>" >
                            <i class="icon-pencil icon-white"></i> Edit
                          </a>
                          <a href="<?php echo base_url()."master_jabatan/deleteJabatan/".$value['kode_jenis_simpanan'] ?>" class="btn btn-default fa fa-trash btn-default" >
