                ...
                <div class="span9" id="content">
                            ...
                            <div class="navbar">
                                <div class="navbar-inner">
                                    <ul class="breadcrumb">
                                        ...
                                        <li>
                                            <a href="#" class="active">Dashboard</a> <span class="divider">/</span>    
                                        </li>
                                        <li>
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            ...
                            <div id="catchart" class="block-content collapse in" style="width:100%;height:300px"></div>
...
<?php $this->load->View("footer"); ?>
    ...
    <link rel="stylesheet" href="<?php echo base_url() ?>asset/bootstrap/vendors/morris/morris.css">
    <script src="<?php echo base_url() ?>asset/bootstrap/vendors/jquery.knob.js"></script>
    <script src="<?php echo base_url() ?>asset/bootstrap/vendors/raphael-min.js"></script>
    <script src="<?php echo base_url() ?>asset/bootstrap/vendors/morris/morris.min.js"></script>
    <script src="<?php echo base_url() ?>asset/bootstrap/vendors/flot/jquery.flot.js"></script>
    <script src="<?php echo base_url() ?>asset/bootstrap/vendors/flot/jquery.flot.categories.js"></script>
    <script src="<?php echo base_url() ?>asset/bootstrap/vendors/flot/jquery.flot.pie.js"></script>
    <script src="<?php echo base_url() ?>asset/bootstrap/vendors/flot/jquery.flot.time.js"></script>
    <script src="<?php echo base_url() ?>asset/bootstrap/vendors/flot/jquery.flot.stack.js"></script>
    <script src="<?php echo base_url() ?>asset/bootstrap/vendors/flot/jquery.flot.resize.js"></script>
