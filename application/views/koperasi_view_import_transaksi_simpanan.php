...
<section class="content">
  ...
  <div class="box box-info">
    <div class="box-header with-border">
      <h3 class="box-title">Form Import Transaksi Simpanan</h3>
  ...
  <div class="span12 hidden">
    ...
    <!-- form start -->
    <form class="form-horizontal" id="form_noHide" action="<?php echo base_url() ?>Import_transaksi_simpanan/insert" method="post">
      <div class="box-body">
