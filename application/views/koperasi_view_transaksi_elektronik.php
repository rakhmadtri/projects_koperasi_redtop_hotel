...
<section class="content">
  ...
  <div class="box box-info">
    <div class="box-header with-border">
      <h3 class="box-title">Form Transaksi Elektronik</h3>
  ...
  <div class="span12 hidden">
    ...
    <!-- form start -->
    <form class="form-horizontal" id="form_noHide" action="<?php echo base_url() ?>transaksi_elektronik/insertTransaction" method="post">
      <div class="box-body">
        <div class="form-group">
          <label for="inputEmail3" class="col-sm-2 control-label" id="name">Anggota</label>
          <div class="col-sm-5">
             <select name="anggota" class="form-control select2" style="width: 100%;" id="kode_barang" required>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-5">
            <input name="nominal" type="text" class="form-control nominal" id="nominal" placeholder="Harga Beli" required>
          </div>
        </div>
      </div>
