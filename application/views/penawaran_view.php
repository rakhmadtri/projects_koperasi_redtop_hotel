                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Generated Penawaran</div>
                            </div>
...
<!--                   <div class="btn-group">
          ...
          <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example2">
              ...
              <tbody>
               <?php if (isset($all_penawaran)): ?>

                <?php foreach ($all_penawaran as $key => $value) {
                   ?>
                     <tr class="odd gradeX">
                      ...
                      <td class="center"><?php echo $value['total_customer_price'] ?></td>
                      <td valign="center">
                          <a style="width:70px" href="generate_penawaran/cetak_penawaran/<?php echo $value['order_id']?>/1" class="btn btnPrintInvoice">
                                <i class="icon-print"></i>PO
                          </a>
                      </td>
                    </tr>
                  <?php  } ?>
