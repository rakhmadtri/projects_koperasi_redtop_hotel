...
<section class="content">
  <div class="box box-info">
    <div class="box-header with-border">
      <h3 class="box-title">Form Transaksi Penjualan</h3>
    </div><!-- /.box-header -->
                ...
                <div class="col-md-6">
                    <div class="form-group">
                      <label class="col-md-6" for="pelanggan">Pelanggan</label>
                        <div class="col-md-6">
                            <select name="anggota" class="form-control select2" style="width: 100%;" id="combocustomer" required>
...
<!--                     <div class="form-group" id="newcustomer">
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-2">
                    ...
                    <span id="harga" class="form-control"></span>
                </div>
                <div class="col-md-2">
...
<!--                                                  <tr class="empty-detail">
                ...
                <tfoot>
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <input type="text" name="pph" id="pph" class="form-control" autocomplete="off" value="<?php echo (isset($detail_penjualan[0]['pph'])?$detail_penjualan[0]['pph']:""); ?>">
                        </td>
                    </tr>
                     <tr>
                        <th colspan="4">
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <input type="text" name="cash" id="cash" class="form-control" autocomplete="off" >
                        </td>
                    </tr>
                    <tr>
                        <th colspan="4">
                        ...
                        <td colspan="2">
                            <input type="text" id="kredit" name="kredit" class="form-control" autocomplete="off" value="<?php echo (isset($detail_penjualan[0]['pph'])?$detail_penjualan[0]['pph']:""); ?>">
                        </td>
                    </tr>
                </tfoot>
            </table>
...
<script type="text/javascript" src="<?php echo base_url()."asset/my_js/trx_pengeluaran.js" ?>"></script>
